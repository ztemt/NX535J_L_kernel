...
#include "imx258mipiraw_sub_541_Sensor.h"

/****************************Modify following Strings for debug****************************/
#define PFX "IMX258_sub_541_camera_sensor"
...
#define imx258_SUB_541_I2C_SPEED 400

static DEFINE_SPINLOCK(imgsensor_drv_lock);

//kal_bool Is_longExp_front=0;  //tanyijun add 

static BYTE imx258_sub_541_SPC_data[252]={0};

extern void read_imx258_sub_541_SPC( BYTE* data );
extern void read_imx258_sub_541_DCC( kal_uint16 addr,BYTE* data, kal_uint32 size);

static imgsensor_info_struct imgsensor_info = {
    .sensor_id = IMX258_SUB_541_SENSOR_ID,        //record sensor id defined in Kd_imgsensor.h
...
#define IMX258_SUB_541_HDR_TYPE (0x00)
#define IMX258_SUB_541_BINNING_TYPE (0x10)
#define IMX258_SUB_541_NOPDAF_TYPE	(0x30)
kal_uint16 imx258_sub_541_type = 0;/*0x00=HDR type, 0x10=binning type*/
...
#define IMX258MIPI_SUB_541_MaxGainIndex (154)
kal_uint16 IMX258MIPI_SUB_541_sensorGainMapping[IMX258MIPI_SUB_541_MaxGainIndex][2] ={
	{64 ,0	},
	{65 ,8	},
	{66 ,16 },
	{67 ,25 },
...
static kal_uint16 read_cmos_sensor(kal_uint32 addr)
{
    ...
    kdSetI2CSpeed(imx258_SUB_541_I2C_SPEED);
...
static void imx258_sub_541_apply_SPC(void)
{
	int i;

	if(read_spc_flag == FALSE)
	{
		read_imx258_sub_541_SPC(imx258_sub_541_SPC_data);
		read_spc_flag = TRUE;
		return;
	}
	...
	for(i=0; i<63; i++)
	{
		write_cmos_sensor(0xD04C+i, imx258_sub_541_SPC_data[i]);
		LOG_INF("SPC_Data[%d] = %d\n", i, imx258_sub_541_SPC_data[i]);
		//LOG_INF("read_SPC_Data[%d] = %d\n", i, read_cmos_sensor(0xD04C+i));
	}
	for(i=0; i<63; i++)
	{
		write_cmos_sensor(0xD08C+i, imx258_sub_541_SPC_data[i+63]);
		LOG_INF("SPC_Data[%d] = %d\n", i+63, imx258_sub_541_SPC_data[i+63]);
   ...
   while(retry--)
	{
		 ...
		 {
		 	 imx258_sub_541_type = read_cmos_sensor(0x0A2E);
             imx258_sub_541_type = IMX258_SUB_541_NOPDAF_TYPE;//ZTEMT:wangkai disable front cam PDAF
			 LOG_INF("imx258_sub_541 type = 0x%x(0x00=HDR,0x10=binning,0x30=No PDAF)", imx258_sub_541_type);
...
static kal_uint16 gain2reg(const kal_uint16 gain)
{
    ...
    for (i = 0; i < IMX258MIPI_SUB_541_MaxGainIndex; i++) {
        if(gain <= IMX258MIPI_SUB_541_sensorGainMapping[i][0]){
            break;
        }
    }
    if(gain != IMX258MIPI_SUB_541_sensorGainMapping[i][0])
            LOG_INF("Gain mapping don't correctly:%d %d \n", gain, IMX258MIPI_SUB_541_sensorGainMapping[i][0]);
    return IMX258MIPI_SUB_541_sensorGainMapping[i][1];
}
...
static void imx258_sub_541_ImageQuality_Setting(void)
{
	if((imx258_sub_541_type == IMX258_SUB_541_HDR_TYPE)||(imx258_sub_541_type == IMX258_SUB_541_NOPDAF_TYPE))
	{
	...
	else if(imx258_sub_541_type == IMX258_SUB_541_BINNING_TYPE)
	{
		write_cmos_sensor(0x94C7,0xFF);
		write_cmos_sensor(0x94C8,0xFF);
		write_cmos_sensor(0x94C9,0xFF);
...
static void sensor_init(void)
{
	...
	imx258_sub_541_ImageQuality_Setting();
	if(imx258_sub_541_type != IMX258_SUB_541_NOPDAF_TYPE)
	{
		imx258_sub_541_apply_SPC();
                      ...
                      MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	if(imx258_sub_541_type == IMX258_SUB_541_HDR_TYPE)
...
static kal_uint32 imx258_sub_541_awb_gain(SET_SENSOR_AWB_GAIN *pSetSensorAWB)
{
    
    UINT32 rgain_32, grgain_32, gbgain_32, bgain_32;

LOG_INF("imx258_sub_541_awb_gain\n");
    ...
    LOG_INF("[imx258_sub_541_awb_gain] ABS_GAIN_GR:%d, grgain_32:%d\n", pSetSensorAWB->ABS_GAIN_GR, grgain_32);
    LOG_INF("[imx258_sub_541_awb_gain] ABS_GAIN_R:%d, rgain_32:%d\n", pSetSensorAWB->ABS_GAIN_R, rgain_32);
    LOG_INF("[imx258_sub_541_awb_gain] ABS_GAIN_B:%d, bgain_32:%d\n", pSetSensorAWB->ABS_GAIN_B, bgain_32);
    LOG_INF("[imx258_sub_541_awb_gain] ABS_GAIN_GB:%d, gbgain_32:%d\n", pSetSensorAWB->ABS_GAIN_GB, gbgain_32);
                             ...
                             UINT8 *feature_para,UINT32 *feature_para_len)
{
    ...
    switch (feature_id) {
		...
		case SENSOR_FEATURE_GET_PDAF_DATA:	
			...
			//read_imx258_sub_541_DCC((kal_uint16 )(*feature_data),(char*)(uintptr_t)(*(feature_data+1)),(kal_uint32)(*(feature_data+2)));
		...
		case SENSOR_FEATURE_SET_AWB_GAIN:
            imx258_sub_541_awb_gain(pSetSensorAWB);
            break;
		/*END OF HDR CMD*/
		/*PDAF CMD*/
...
UINT32 IMX258_MIPI_RAW_SUB_541_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
    /* To Do : Check Sensor status here */
    if (pfFunc!=NULL)
        *pfFunc=&sensor_func;
    return ERROR_NONE;
}    /*    IMX258_MIPI_RAW_SUB_541_SensorInit    */
