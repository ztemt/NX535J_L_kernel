...
/*argus dct tool error workaround for build error*/
#define MT6325_POWER_LDO_VGP1 1
#define MT6325_POWER_LDO_VGP2 1
#define MT6325_POWER_LDO_VCAMA 1
#define MT6325_POWER_LDO_VCAMD	 1
#define MT6325_POWER_LDO_VCAM_IO 1
#define MT6325_POWER_LDO_VCAM_AF1 1
#define MT6325_POWER_LDO_VCAMA 1
#define MT6325_POWER_LDO_POWER_D 1
#define MT6325_POWER_LDO_VCAM_AF 1
#define MT6325_POWER_LDO_POWER_IO 1
...
//extern void pmic_ldo_vol_sel(MT65XX_POWER powerId, MT_POWER_VOLTAGE powerVolt);

extern bool hwPowerOn(MT65XX_POWER powerId, int powerVolt, char *mode_name);
