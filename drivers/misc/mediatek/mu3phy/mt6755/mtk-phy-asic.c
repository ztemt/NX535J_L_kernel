...
PHY_INT32 phy_init_soc(struct u3phy_info *info)
{
	...
	U3PhyWriteField32(U3D_U2PHYDTM0, E60802_FORCE_SUSPENDM_OFST, E60802_FORCE_SUSPENDM, 0);
#endif
	U3PhyWriteField32(U3D_USBPHYACR1, E60802_RG_USB20_VRT_VREF_SEL_OFST, E60802_RG_USB20_VRT_VREF_SEL, VOL_LEVL);//添加此行，参数5最大值是7
	U3PhyWriteField32(U3D_USBPHYACR1, E60802_RG_USB20_TERM_VREF_SEL_OFST, E60802_RG_USB20_TERM_VREF_SEL, VOL_LEVL); //添加此行，参数5最大值是7 
	/*Wait 800 usec */
	udelay(800);
...
void usb_phy_recover(unsigned int clk_on)
{
	...
	/*U3PhyWriteField32(U3D_USBPHYACR5, E60802_RG_USB20_HS_100U_U3_EN_OFST,
			  E60802_RG_USB20_HS_100U_U3_EN, 1); */
#endif
	U3PhyWriteField32(U3D_USBPHYACR1, E60802_RG_USB20_VRT_VREF_SEL_OFST, E60802_RG_USB20_VRT_VREF_SEL, VOL_LEVL);//添加此行,与phy_init_soc()中一致 
	U3PhyWriteField32(U3D_USBPHYACR1, E60802_RG_USB20_TERM_VREF_SEL_OFST, E60802_RG_USB20_TERM_VREF_SEL, VOL_LEVL); //添加此行,与phy_init_soc()中一致 
	/*
