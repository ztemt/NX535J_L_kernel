...
/*
    ...
    */
	...
	LOG_INF("[DW9714AF] DW9714AF_ReadReg\n");
	...
	LOG_INF("[DW9714AF] DW9714AF_ReadReg VCMMSB: 0x%x\n", pBuff[1]);
	...
	LOG_INF("[DW9714AF] DW9714AF_ReadReg VCMLSB: 0x%x\n", pBuff[0]);
	...
	*a_pu2Result = ((u16)( pBuff[0]>>6) + (u16) (pBuff[1] << 2));
	LOG_INF("[DW9714AF] DW9714AF_ReadReg *a_pu2Result: %d\n", *a_pu2Result);
...
static int DW9714_Mode_Init(void)
{
    int i4RetValue = 0;
    char REG32H[2] = { (char)(0x32), (char)(0x00) };	
    char REG02H[2] = { (char)(0x02), (char)(0x00) };

    LOG_INF("[DW9714AF] DW9714_Mode_Init :0x02\n");
