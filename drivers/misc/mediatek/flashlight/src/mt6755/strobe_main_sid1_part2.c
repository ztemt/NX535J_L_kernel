...
int setDuty_LM3643_2(int duty)
{
	...
	PK_DBG("hljing setDuty_LM3643_2:m_duty = %d, m_duty2_flash2 = %d!\n", m_duty1_flash2, m_duty2_flash2);
	PK_DBG("hljing LED1Closeflag_flash2 = %d, LED2Closeflag_flash2 = %d\n", LED1Closeflag_flash2, LED2Closeflag_flash2);
...
int FL_Enable_flash2(void)
{
	...
	PK_DBG(" FL_Enable_flash2 line=%d\n",__LINE__);
...
{
	PK_DBG(" FL_Disable_flash2 line=%d\n",__LINE__);
    return 0;
}
...
int FL_dim_duty_flash2(kal_uint32 duty)
{
    ...
    PK_DBG(" FL_dim_duty_flash2 line=%d\n",__LINE__);
    return 0;
}
...
{
    int i4RetValue = 0;
    PK_DBG("kdebug flash2 led1 constant_flashlight_open line=%d\n", __LINE__);
