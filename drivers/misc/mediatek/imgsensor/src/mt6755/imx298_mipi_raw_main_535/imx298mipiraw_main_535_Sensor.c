...
#include "imx298mipiraw_main_535_Sensor.h"

/****************************Modify following Strings for debug****************************/
#define PFX "IMX298_main_535_camera_sensor"
...
static imgsensor_info_struct imgsensor_info = {
    .sensor_id = IMX298_MAIN_535_SENSOR_ID,        //record sensor id defined in Kd_imgsensor.h
...
UINT32 IMX298_MIPI_RAW_MAIN_535_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
