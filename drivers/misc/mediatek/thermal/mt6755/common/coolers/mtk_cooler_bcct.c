...
int get_bat_charging_current_level(void) { return 0; }
kal_uint32 set_chr_input_current_limit(int current_limit) { return 0; }
kal_uint32 set_bat_charging_current_limit(int current_limit) {return 0; }
#endif
