...
#include "imx258mipiraw_main_541_Sensor.h"

/****************************Modify following Strings for debug****************************/
#define PFX "IMX258_main_541_camera_sensor"
...
static imgsensor_info_struct imgsensor_info = {
    .sensor_id = IMX258_MAIN_541_SENSOR_ID,        //record sensor id defined in Kd_imgsensor.h
...
UINT32 IMX258_MIPI_RAW_MAIN_541_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
