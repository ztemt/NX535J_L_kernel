...
static struct device_attribute attrs[] = {
	...
	__ATTR(palm_sleep, (S_IRUGO | S_IWUGO),
...
/*
...
#endif //add 3.3v end*/
       hwPowerOn(TPD_POWER_SOURCE, VOL_3300, "touch_vdd");
	...
	/* OPTIONAL: hardware reset pin toggling */
      ...
      mt_set_gpio_mode(GPIO_CTP_EINT_PIN, GPIO_CTP_EINT_PIN_M_EINT);
        ...
        mt_set_gpio_out(GPIO_CTP_RST_PIN, GPIO_OUT_ONE);// reset pin high
	msleep(DELAY_BOOT_READY);
	
	mt_set_gpio_out(GPIO_CTP_RST_PIN, GPIO_OUT_ZERO);// reset pin low
