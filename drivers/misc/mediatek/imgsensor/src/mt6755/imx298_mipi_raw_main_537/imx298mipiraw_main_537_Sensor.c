...
#include "imx298mipiraw_main_537_Sensor.h"

/****************************Modify following Strings for debug****************************/
#define PFX "IMX298_main_537_camera_sensor"
...
static imgsensor_info_struct imgsensor_info = {
    .sensor_id = IMX298_MAIN_537_SENSOR_ID,        //record sensor id defined in Kd_imgsensor.h
...
kal_uint16 sensor_id = 0;
   ...
   sensor_id = (kal_uint16)((read_cmos_sensor(0x0A29) << 4) | (read_cmos_sensor(0x0A2A)>>4));
   if(sensor_id == 0x0298)
   return 0x0299;
...
UINT32 IMX298_MIPI_RAW_MAIN_537_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
