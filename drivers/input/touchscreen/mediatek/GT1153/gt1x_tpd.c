...
#define GPIO_TP_AVDD_EN 	(GPIO21 | 0x80000000)
...
static struct i2c_board_info __initdata i2c_tpd = {I2C_BOARD_INFO(GTP_DRIVER_NAME, (0x28 >> 1))};
...
extern s32 gtp_test_sysfs_deinit(void);
