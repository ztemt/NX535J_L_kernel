...
#define TPD_KEYS_DIM            			{{300,2050,20,TPD_BUTTON_HEIGH}, {550,2050,20,TPD_BUTTON_HEIGH}, {800,2050,20,TPD_BUTTON_HEIGH}}
...
extern int fts_i2c_read_testa(/*struct i2c_client *client,*/ char *writebuf,int writelen, char *readbuf, int readlen);
extern int fts_i2c_write_testa(/*struct i2c_client *client,*/ char *writebuf, int writelen);
