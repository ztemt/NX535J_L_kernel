...
#include "imx179mipiraw_sub_537_Sensor.h"

/****************************Modify following Strings for debug****************************/
#define PFX "imx179_sub_537_camera_sensor"
...
static imgsensor_info_struct imgsensor_info = { 
	.sensor_id = IMX179_SUB_537_SENSOR_ID,
...
static kal_uint32 return_sensor_id()
{
	...
	sensor_id = (((read_cmos_sensor(0x0002)&&0x0f)<<8)  | (read_cmos_sensor(0x0003)) );
							 ...
							 UINT8 *feature_para,UINT32 *feature_para_len)
{
	...
	switch (feature_id) {
		...
		case SENSOR_FEATURE_SET_GAIN:		
			...
			break;
	      //ZTEMT: tanyijun add for snapshot mirror start 
		case SENSOR_FEATURE_SET_SNPSHOT_MIRROR:		
                     //set_mirror_flip((kal_uint8) *feature_data); //ZTEMT: comment by congshan 
			break;			
	      //ZTEMT: tanyijun add for snapshot mirror end 
...
UINT32 IMX179_MIPI_RAW_SUB_537_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
