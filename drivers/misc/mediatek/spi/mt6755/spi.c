...
#else
	int ret;
      //when system in sleep mode,should prepare clk,then enable. 2016.03.14 .modified by peterhoul
      //clk_prepare_enable means clk_prepare +clk_enable
...
#else
       //when system in sleep mode,should disable clk,then unprepare. 2016.03.14 .modified by peterhoul
       //clk_disable_unprepare means clk_disable +clk_unprepare
