/*
 * BU6429AF_MAIN_537 voice coil motor driver
 *
 *
 */
...
#define AF_DRVNAME "BU6429AF_MAIN_537_DRV"
...
{
	int i4RetValue = 0;
    //resonant_frequency = 142; 1 ~ 255   0.4*142+30hz=87Hz
    u16 resonant_frequency = 142;  // 87hz need modify every module
    u16 ISRC_value = 1;
    g_pstAF_I2Cclient->addr = AF_I2C_SLAVE_ADDR;
	...
	#else
    char puSendCmd_rf[2] = {(char)(((resonant_frequency >> 8) & 0x03) | 0xD4), (char)(resonant_frequency & 0xFF)};
    i4RetValue = i2c_master_send(g_pstAF_I2Cclient, puSendCmd_rf, 2);
    if (i4RetValue < 0) {
		LOG_INF("I2C send failed!!\n");
		return -1;
	}
    char puSendCmd_isrc[2] = {(char)(((ISRC_value >> 8) & 0x03) | 0xCC), (char)(ISRC_value & 0x07)};
    i4RetValue = i2c_master_send(g_pstAF_I2Cclient, puSendCmd_isrc, 2);
    if (i4RetValue < 0) {
		LOG_INF("I2C send failed!!\n");
		return -1;
	}
    char puSendCmd_data[2] = {(char)(((a_u2Data >> 8) & 0x03) | 0xC4), (char)(a_u2Data & 0xFF)};
...
/* ////////////////////////////////////////////////////////////// */
long BU6429AF_MAIN_537_Ioctl(struct file *a_pstFile, unsigned int a_u4Command, unsigned long a_u4Param)
{
	long i4RetValue = 0;
...
int BU6429AF_MAIN_537_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
	LOG_INF("Start\n");
...
void BU6429AF_MAIN_537_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock, int *pAF_Opened)
{
