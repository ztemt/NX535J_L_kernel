 ...
 *
 ****************************************************************************/
#ifndef _IMX258mipi_sub_537_SENSOR_H
#define _IMX258mipi_sub_537_SENSOR_H
...
//ZTEMT: tanyijun add start 
typedef enum {
	
SENSOR_AE_STATUS_IS_SLOW_SHUTTER = 0,
SENSOR_AE_STATUS_IS_NORMAL_SHUTTER,
	
}KERNEL_SENSOR_AE_STATUS_ENUM;
//ZTEMT: tanyijun add end
...
//extern void read_imx259_eeprom( void);
